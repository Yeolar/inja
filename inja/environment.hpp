...
public:
  ...
  Template parse_template(const std::string &filename) {
    ...
    parser.parse_into_template(result, input_path + filename);
    return result;
  }
  ...
  std::string render(acc::StringPiece input, const json &data) { return render(parse(input), data); }
...
*/
inline std::string render(acc::StringPiece input, const json &data) {
...
*/
inline void render_to(std::ostream &os, acc::StringPiece input, const json &data) {
  Environment env;
